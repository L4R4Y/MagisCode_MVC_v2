...
<div class="panel">
    ...
    <form method="post" class="form-grid">
        ...
        <?php if ($usernameGenerado !== ''): ?>
            <div class="field full">
                <label>Usuario que se creará</label>
                <input type="text" value="<?= htmlspecialchars($usernameGenerado) ?>" readonly disabled>
                <span class="field-hint">El nombre de usuario se genera automáticamente a partir del nombre, apellido y documento.</span>
            </div>

            <div class="field full">
                <label>Contraseña temporal</label>
                <input type="text" value="<?= htmlspecialchars($passwordGenerado) ?>" readonly disabled>
                <span class="field-hint">Contraseña generada aleatoriamente. Se enviará al correo del aprendiz (si es Aprendiz).</span>
            </div>
        <?php endif; ?>
